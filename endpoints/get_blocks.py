...
from helper.mining_address import get_miner_payload_from_block, retrieve_miner_info_from_payload, toAddress
                ...
                "outputs": [
                    {
                        ...
                        "verboseData": {
                            ...
                            "scriptPublicKeyAddress": toAddress(tx_out.script_public_key),
                        },
                    }
